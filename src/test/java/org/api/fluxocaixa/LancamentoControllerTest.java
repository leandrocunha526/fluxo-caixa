...
public class LancamentoControllerTest {
        ...
        public void testCriarLancamentos() throws Exception {
                ...
                when(lancamentoService.salvar(any(Lancamento.class))).thenReturn(lancamento1, lancamento2, lancamento3,
                                lancamento4);
        ...
        public void testConsultarSaldo() throws Exception {
                ...
                List<SaldoDiarioDTO> saldoDiario = Arrays.asList(
                                new SaldoDiarioDTO(LocalDate.of(2025, 4, 23), BigDecimal.valueOf(1000.00),
                                                BigDecimal.valueOf(250.00), BigDecimal.valueOf(750.00)),
                                new SaldoDiarioDTO(LocalDate.of(2025, 4, 24), BigDecimal.valueOf(700.00),
                                                BigDecimal.ZERO, BigDecimal.valueOf(700.00)));
        ...
        public void testEditarLancamento() throws Exception {
                ...
                when(lancamentoService.atualizar(any(Long.class), any(Lancamento.class)))
        ...
        public void testRemoverLancamento() throws Exception {
                ...
                mockMvc.perform(delete("/api/delete/1")
                                ...
                                .andExpect(jsonPath("$").value("Excluído com sucesso!")); // Espera a mensagem de
                                                                                          // sucesso
        }
}
